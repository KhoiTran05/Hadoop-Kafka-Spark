...
echo " Find the Python process"
echo "  docker-compose exec jupyter ps aux | grep email_alert_consumer.py"
echo "  Kill the process (replace <PID> with the actual process ID)"
echo "  docker-compose exec jupyter kill <PID>"
echo ""